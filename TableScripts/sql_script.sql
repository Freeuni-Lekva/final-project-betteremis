...
CREATE TABLE STUDENT_CLASSROOMS(
    ...
    CONSTRAINT unique_constraint unique (ClassroomID, StudentID),
    FOREIGN KEY (ClassroomID) REFERENCES CLASSROOMS(ID) on DELETE CASCADE,
    FOREIGN KEY (StudentID) REFERENCES STUDENTS(ID) ON DELETE CASCADE
);

INSERT INTO USERS (Email, PasswordHash, Privilege) VALUES ('mrtsima@gmail.com', '$2a$10$iRKpv1fOEuO2a76AvGzXCOdG0XVgNId/maB96uoBDWZCugaOaUIAy', 'Admin');