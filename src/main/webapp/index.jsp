...
<div class="grid">
    ...
    <p class="text--center">Forgot a password ? <a href="resetPass.jsp">Reset now</a> <svg class="icon">
        <use xlink:href="#icon-arrow-right"></use>
    </svg></p>

    <p class="text--center">University WebPage ? <a href="https://freeuni.edu.ge/">Click Here</a> <svg class="icon">
        <use xlink:href="#icon-arrow-right"></use>
    </svg></p>
...
<a href="privateMessenger.jsp">messenger</a>
